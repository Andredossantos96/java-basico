...
o que restou para você fazer foi o contador de porcentagem de download 
dos pacotes. Mas como o espaço para essa informação ficou pequeno, 
...
public class DownloadPacotes {
    public static void main(String[] args) {
        ...
        printProgresso(tamanho);

    }
        public static void printProgresso(int numero) {
            while(numero>0){
                numero--;
                System.out.print("/");
            }
